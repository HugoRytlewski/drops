...
<template>
    ...
    <footer class="z-20 fixed inset-x-0 bottom-10 mx-auto bg-black w-56 h-14 rounded-full flex justify-around items-center">
      <div class=" rounded-full h-10 w-10 justify-center flex items-center cursor-pointer" :class="{ 'bg-white rounded-full text-black fill-black': home }">
        <svg class="hover:opacity-75 duration-200 h-6 w-6 text-black cursor-pointer " :class="{ 'bg-white rounded-full text-black fill-black': home }" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#FFFFFF"><path d="M0 0h24v24H0z" fill="none"/><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>

      </div>
      <div class=" rounded-full h-10 w-10 justify-center flex items-center cursor-pointer" :class="{ 'bg-white rounded-full text-black fill-black': search }">
    ...
    <div class=" rounded-full h-10 w-10 justify-center flex items-center cursor-pointer" :class="{ 'bg-white rounded-full text-black fill-black': favorite }">
    ...
    <div class=" rounded-full h-10 w-10 justify-center flex items-center cursor-pointer" :class="{ 'bg-white rounded-full text-black fill-black': profile }">
    ...
    <div class="z-0 flex flex-col justify-center md:items-center min-h-screen bg-neutral-950 text-white">
      <div class="pt-16 pb-4 px-4">
        ...
        <div class="flex overflow-x-auto snap-x snap-mandatory mt-10">
  <div class=" shrink-0 w-full flex flex-none gap-10">

    <div class="min-w-full md:min-w-0">
      <div class="bg-white text-black rounded-t-xl p-3">
      ...
      <div class="relative bg-white rounded-b-xl p-3 flex flex-col items-center">
        ...
        <div class="mt-4 bg-green-600 rounded-xl">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4 p-3">
            ...
            <NuxtLink to="/produit1">

            <div class="bg-black text-black h-72 rounded-xl p-3 flex flex-col items-center cursor-pointer  duration-200 hover:bg-neutral-950">
